...
const ENV_URL="http://localhost:3000/api";
...
getItemsWithFilters(
  ...
  addItem(itemName: string, itemSellingPrice: number, itemCostPrice:number, itemQuantity:number) {
    
    const item: Item = { _id: null, itemName: itemName, itemSellingPrice: itemSellingPrice,itemCostPrice:itemCostPrice,itemQuantity:itemQuantity,creator:null };
    this.httpClient
  ...
  updateItem(_id: string, itemName: string, itemSellingPrice: number, itemCostPrice:number, itemQuantity:number) {
    const item: Item = { _id: _id, itemName: itemName, itemSellingPrice: itemSellingPrice, itemCostPrice:itemCostPrice,itemQuantity:itemQuantity,creator:null };
    this.httpClient
      .put(BACKEND_URL+"/" + _id, item)
      .subscribe(response => {
  ...
  updateItemFromOrderService(_id: string, itemName: string, itemSellingPrice: number, itemCostPrice:number, itemQuantity:number) {
    const item: Item = { _id: _id, itemName: itemName, itemSellingPrice: itemSellingPrice, itemCostPrice:itemCostPrice,itemQuantity:itemQuantity,creator:null };
