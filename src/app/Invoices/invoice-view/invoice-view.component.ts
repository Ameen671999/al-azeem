...
{
  this.invoiceNo_value=(this.invoice.orderBillNo).substring((this.invoice.orderBillNo).search("-")+1)
}
            ...
            if (this.orderId != null) {
              this.ordersService.getOrder(this.orderId).subscribe(orderData => {
                ...
                if (this.order) {
                  this.totalCost_order = this.order.totalCost;
                  this.SGST_Val=Number(((this.SGST_invoice*this.totalCost_order)/100).toFixed(2));
                  this.CGST_Val=Number(((this.CGST_invoice*this.totalCost_order)/100).toFixed(2));
                  this.IGST_Val=Number(((this.IGST_invoice*this.totalCost_order)/100).toFixed(2));
                }
